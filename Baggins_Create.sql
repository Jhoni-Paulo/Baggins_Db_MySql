...
CREATE TABLE IF NOT EXISTS `bagginsdb`.`oportunidade` (
  ...
  `salario` VARCHAR(45) NULL DEFAULT '0',
  `ativa` INT NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  INDEX `fk_tipo_oportunidade_idx` (`idTipoOportunidade` ASC) VISIBLE,
  INDEX `fk_oportunidade_anfitriao_id_idx` (`idAnfitriao` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bagginsdb`.`curriculo` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_idioma_pessoa_idx` (`idPessoa` ASC) VISIBLE,
